...
<head>
    ...
    <link rel="stylesheet" href="../../scripts/css/AddTweet.css">
</head>
...
<?php include('../../components/common/header.php') ?>
    ...
    <main class="ml-60 mx-auto px-4 sm:px-6 lg:px-8 pt-8 mt-12" id="main">
        ...
        <div class="fixed top-4 right-4 z-50 space-y-3" id="toast-container">
            ...
            <div class="flex items-center w-full max-w-xs p-4 bg-white border-l-4 border-green-500 rounded-lg shadow-lg transform transition-all duration-300 ease-in-out animate-slide-in-right"
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-gray-800"><?php echo $_SESSION['success_message']; ?></p>
                </div>
                <button type="button"
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            <!-- Left Column - Tweet Form -->
            <div class="lg:col-span-2">
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6 mb-8">
                    <form action="../../handlers/handleUserPost/handletweet.php" method="post" id="AddForm">
                        <!-- Content Input Section -->
                        <section class="mb-6">
                            <h2 class="flex items-center text-xl font-semibold text-gray-800 dark:text-white mb-4">
                                <i class="fas fa-feather text-blue-500 mr-2"></i>
                                Compose Tweet
                            </h2>
                            ...
                            <div class="mb-6">
                                <div class="relative">
                                    ...
                                    <textarea id="tweetContent" rows="4" maxlength="500" name="tweetContent"
                        ...
                        <section class="mb-8">
                            ...
                            <div class="mb-3">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">Add hashtags to help others discover your tweet</p>
                            </div>
                        ...
                        <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                            <label class="flex items-center cursor-pointer gap-3 order-2 sm:order-1">
                                ...
                                <span class="text-gray-700 dark:text-gray-300">Tweet Anonymously</span>
                            </label>

                            <button type="submit"
                                class="order-1 sm:order-2 px-6 py-3 bg-blue-600 hover:bg-blue-700 text-white font-medium rounded-lg transition-colors shadow-md hover:shadow-lg w-full sm:w-auto flex items-center justify-center gap-2">
                ...
                <div class="sticky top-8">
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden mb-6">
                        <div class="bg-blue-600 text-white px-6 py-4">
                            <h2 class="font-bold text-lg">Tweet Preview</h2>
                            <p class="text-blue-100 text-sm">See how your tweet will look</p>
                        </div>
                        <div class="p-6">
                            <div class="flex items-center space-x-3 mb-4 pb-4 border-b border-gray-100 dark:border-gray-700">
                            ...
                            <div class="mb-4">
                                <p id="previewText" class="text-gray-700 dark:text-gray-300">Your tweet preview will appear here...</p>
                            </div>
                            ...
                            <div class="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700">
                                <div class="flex justify-between text-gray-500 dark:text-gray-400 text-sm">
                                    ...
                                    <button class="flex items-center hover:text-blue-600 transition-colors">
                                        <i class="fas fa-retweet mr-1"></i> Retweet
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                        <h3 class="font-medium text-gray-800 dark:text-white mb-3">Tweeting Tips</h3>
                        <ul class="space-y-3 text-sm text-gray-600 dark:text-gray-300">
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                                <span>Keep it concise and to the point</span>
                            </li>
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                            ...
                            <li class="flex items-start">
                                <i class="fas fa-check-circle text-green-500 mt-1 mr-2"></i>
                                <span>Engage with replies to build community</span>
                            </li>
                        </ul>
                        </ul>
                </div>
   ...
   <?php  include('../../scripts/js/addTweet.php') ?>
